...
<div class="row">
  <div class="col col-md-12">
    <div class="card">
      <h3 class="card-title">Formulir Tambah Transaksi</h3>
      {{ Form::open(['route' => ['transactions.store'], 'method'=> 'POST', 'enctype'=> 'multipart/form-data', 'class'=>'form-horizontal']) }}
      <div class="card-body">
          ...
          <div id="base_data" class="tab-pane fade in active">
            <div class="row" style="margin-top: 15px">
              <div class="col-md-12">
                ...
                <div class="col-md-10">
                  <input class="form-control" id="transaction_date" type="text" name="transaction_date"></input>
                </div>
              </div>
                ...
                <div class="col-md-6">
                  <select class="form-control" name="dropoff_store_id">
                    @foreach($dropoffStores as $dropoffStore)
                      <option value="{{ $dropoffStore->id }}">{{ $dropoffStore->name }}</option>
                    @endforeach 
                  </select>
                </div>
                <div class="col-md-4">
                  <input class="form-control money" name="dropoff_store_price" type="text" value="0"></input>
                </div>
              </div>
              <div class="col-md-12" style="margin-top: 10px">
                <div class="col-md-2 text-right">
                ...
                <div class="col-md-10">
                  <input class="form-control money" type="text" name="electricity_exp" value="0"></input>
                </div>
              </div>
              <div class="col-md-12" style="margin-top: 10px">
                <div class="col-md-2 text-right">
                ...
                <div class="col-md-10">
                  <input class="form-control money" type="text" name="gasoline_exp" value="0"></input>
                </div>
              </div>
              <div class="col-md-12" style="margin-top: 10px">
                <div class="col-md-2 text-right">
                ...
                <div class="col-md-10">
                  <input class="form-control money" type="text" name="eat_exp" value="0"></input>
                </div>
              </div>
              <div class="col-md-12" style="margin-top: 10px">
                <div class="col-md-2 text-right">
                ...
                <div class="col-md-10">
                  <input class="form-control money" type="text" name="police_exp" value="0"></input>
                </div>
              </div>
              <div class="col-md-12" style="margin-top: 10px">
                <div class="col-md-2 text-right">
                ...
                <div class="col-md-10">
                  <input class="form-control money" type="text" name="park_exp" value="0"></input>
                </div>
              </div>
            </div>
          </div>
          <div id="bread_transaction" class="tab-pane fade">
            <table class="table table-bordered">
              ...
              @foreach($breads as $index=>$bread)
                <tr>
                  <td class="center">
                    <input type="hidden" name="bread_id[{{ $index }}]" value="{{ $bread->id }}">
                    {{ $bread->name }}
                  </td>
                  <td>
                    <input type="text" class="form-control" name="bring_old_bread[{{ $index }}]" id="bring_old_bread_{{ $index }}" value="0" onchange="calcBreadSold({{ $index }})"></input>
                  </td>
                  <td>
                    <input type="text" class="form-control" name="bring_new_bread[{{ $index }}]" id="bring_new_bread_{{ $index }}" value="0" onchange="calcBreadSold({{ $index }})"></input>
                  </td>
                  <td>
                    <div id="add_bread_{{ $index }}"></div>
                  ...
                  <td>
                    <input type="text" class="form-control" name="return_old_bread[{{ $index }}]" id="return_old_bread_{{ $index }}" value="0" onchange="calcBreadSold({{ $index }})"></input>
                  </td>
                  <td>
                    <input type="text" class="form-control" name="return_new_bread[{{ $index }}]" id="return_new_bread_{{ $index }}" value="0" onchange="calcBreadSold({{ $index }})"></input>
                  </td>
                  <td>
                    <input type="text" class="form-control" id="sold_bread_{{ $index }}" value="0" readonly></input>
                  </td>
                  <td>
                    <input type="text" class="form-control money text-right" id="bread_price_{{ $index }}" name="bread_price[{{ $index }}]" value="{{ $bread->price }}" onchange="calcBreadSold({{ $index }})" readonly></input>
                  </td>
                  <td>
          ...
          <div id="snack_transaction" class="tab-pane fade">
            <table class="table table-bordered">
              ...
              @foreach($snacks as $index=>$snack)
                <tr>
                  <td class="center">
                    <input type="hidden" name="snack_id[{{ $index }}]" value="{{ $snack->id }}">
                    {{ $snack->name }}
                  </td>
                  <td>
                    <input type="text" class="form-control" name="bring_snack[{{ $index }}]" id="bring_snack_{{ $index }}" onchange="calcSnackSold({{ $index }})" value="0"></input>
                  </td>
                  <td>
                    <div id="add_snack_{{ $index }}"></div>
                    <div style="text-align: center">
                  ...
                  <td>
                    <input type="text" class="form-control" name="return_snack[{{ $index }}]" id="return_snack_{{ $index }}" onchange="calcSnackSold({{ $index }})" value="0"></input>
                  </td>
                  <td>
                    <input type="text" class="form-control" id="sold_snack_{{ $index }}" value="0" readonly></input>
                  </td>
                  <td>
                    <input type="text" class="form-control money text-right" name="snack_price[{{ $index }}]" id="snack_price_{{ $index }}" value="{{ $snack->price }}" onchange="calcSnackSold({{ $index }})" readonly></input>
                  </td>
                  <td>
